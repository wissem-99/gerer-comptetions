...
<nav class="navbar navbar-light bg-light fixed-top">
  ...
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h1 class="text-center text-success">Ajouter competition</h1>
        <form action="s5" method="post">
          ...
          <div class="mb-3">
            <label for="nc" class="form-label">Nom competition</label>
          ...
          <div class="mb-3">
            <label for="con" class="form-label">Concept</label>
            <select class="form-control" id="sel1" name="con">
          ...
          <div class="mb-3">
            <label for="ne" class="form-label">decepline </label>
            <select class="form-control" id="sel1" name="cd">
